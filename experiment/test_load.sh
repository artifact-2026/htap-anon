...
ycsb_cmd=( ./src/test/ycsb/ycsb_test
  -db baseline
  -dbpath "/data/test_results/baseline"
...
ycsb_cmd2=( ./src/test/ycsb/ycsb_test
  -db mynoop
  -dbpath "/data/test_results/mynoop"
  -P "../src/test/ycsb/workloads/test_workloada.spec"
  -inputdataformat fixedbin64
  -bootstrap true
  -threads 10
...
ycsb_cmd3=( ./src/test/ycsb/ycsb_test
  -db converting
  -dbpath "/data/test_results/converting"
  -P "../src/test/ycsb/workloads/test_workloada.spec"
  -inputdataformat fixedbin64
  -bootstrap true
  -threads 10
...
ycsb_cmd4=( ./src/test/ycsb/ycsb_test
  -db splitting
  -dbpath "/data/test_results/splitting"
  -P "../src/test/ycsb/workloads/test_workloada.spec"
  -inputdataformat fixedbin64
  -bootstrap true
  -threads 10
...
ycsb_cmd5=( ./src/test/ycsb/ycsb_test
  -db indexing
  -dbpath "/data/test_results/indexing"
  -P "../src/test/ycsb/workloads/test_workloada.spec"
  -inputdataformat fixedbin64
  -bootstrap true
  -threads 10
