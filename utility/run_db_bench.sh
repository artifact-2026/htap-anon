...
# CONFIG
DB_BENCH_CMD="./src/mycelium/db_bench --benchmarks=fillrandom --num=400000 --key_size=16 --value_size=1024 --compression_type=none --threads=8 --disable_wal=false --write_buffer_size=33554432 --db=/holly/bench_results --max_background_compactions=8 --stats_interval_seconds=5"
