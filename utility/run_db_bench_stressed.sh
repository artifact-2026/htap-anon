...
# CONFIG
DB_BENCH_CMD="./src/mycelium/db_bench --benchmarks=fillrandom --num=2500000 --key_size=16 --value_size=1000 --compression_type=none --threads=4 --disable_wal=true --write_buffer_size=67108864 --db=/holly/bench_results --max_background_compactions=8 --stats_interval_seconds=5"
