#ifndef YCSB_CPLUSPLUS_PRECONVERTING_H
#define YCSB_CPLUSPLUS_PRECONVERTING_H
...
class TestPreconverting : public DB{
    public :
        TestPreconverting(const std::string& dbname, const char *dbfilename, utils::Properties &props);
